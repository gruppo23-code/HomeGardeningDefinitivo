...
function Footer() {
    return (
        <footer className="footer bg-light text-dark fixed-bottom sticky-bottom">
            <style>
                {`
                    body {
                        padding-bottom: 60px; /* Assicurati che il valore corrisponda all'altezza del footer */
                    }
                `}
            </style>
            <div className="container pt-2">
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <h5>Seguici</h5>
                        <ul className="list-unstyled">
                            <li><a href="https://facebook.com" className="text-dark" target="_blank" rel="noopener noreferrer">Facebook</a></li>
                    ...
                    <div className="col-md-4">
                        ...
                        <form>
                            <div className="mb-3">
                                <input type="email" placeholder="Inserisci la tua email" className="form-control" required />
                            </div>
